...
-- ---- Claim adjustments (flagged from the Queue) ----
create table if not exists claim_adjustments (
  ...
  reason text default '', initials text default '',
...
-- ---- Marketplace / Exchange plan claims (shifted from the Queue) ----
...
-- ---- Billed claims (CollaborateMD Claims Billed Report; payer per claim) ----
...
-- ---- Attachments (two folders: Medical Records, Licenses & W-9) ----
...
create policy attachments_delete on attachments for delete using (is_management());
